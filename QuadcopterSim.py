...
def CalculateR(attitude):
    """R is the rotation matrix for converting vectors from the body
...
def CalculateT(attitude):
    """T is the transformation matrix for converting a vector of euler
...
xLine = Create3dLine(axes, dict(marker='o', markersize=7, color='c',
                                linewidth=5))
yLine = Create3dLine(axes, dict(marker='o', markersize=7, color='c',
                                linewidth=5))
upLine = Create3dLine(axes, dict(marker='o', markersize=5, markevery=[1],
                                 color='r', linewidth=2))

line_ani = animation.FuncAnimation(figure, RunSimulationTick, None,
